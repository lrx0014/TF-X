...
type VersionClient interface {
	Version(ctx context.Context, in *VersionReq, opts ...grpc.CallOption) (*VersionReply, error)
}
...
func (c *versionClient) Version(ctx context.Context, in *VersionReq, opts ...grpc.CallOption) (*VersionReply, error) {
...
func (UnimplementedVersionServer) Version(context.Context, *VersionReq) (*VersionReply, error) {
...
func _Version_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VersionServer).Version(ctx, req.(*VersionReq))
	}
